...
gulp.task('jar',pjInfo.projects, function() {
	console.log(' Builded  all java projects to jar');
	//del.sync('dist/classes',{force:true});
	//return gulp.start(pjInfo.projects);s
	//
	//console.log(" ------------------------------------------------------------------------");
	//pjInfo.projects.forEach((p)=>{
	//	console.log(` ${p}.jar`);
	//});
	//console.log(" ------------------------------------------------------------------------");
});
...
gulp.task('war',['war-pre'], function() {
